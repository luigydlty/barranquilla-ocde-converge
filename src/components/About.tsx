    ...
    <section id="about" className="section-padding bg-white">
      <div className="container-custom">
          ...
          <div className="bg-gray-50 rounded-xl p-8 shadow-sm">
            ...
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-start">
                <div className="mr-2 mt-1 text-barranquilla-red">•</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-barranquilla-blue/5 rounded-lg p-6 text-center">
            <div className="mx-auto w-16 h-16 flex items-center justify-center rounded-full bg-barranquilla-blue/10 mb-4">
              <Calendar className="h-8 w-8 text-barranquilla-blue" />
            </div>
          ...
          <div className="bg-barranquilla-blue/5 rounded-lg p-6 text-center">
            <div className="mx-auto w-16 h-16 flex items-center justify-center rounded-full bg-barranquilla-blue/10 mb-4">
              <MapPin className="h-8 w-8 text-barranquilla-blue" />
            </div>
            <h3 className="font-bold mb-2">Sede Principal</h3>
          ...
          <div className="bg-barranquilla-blue/5 rounded-lg p-6 text-center">
            <div className="mx-auto w-16 h-16 flex items-center justify-center rounded-full bg-barranquilla-blue/10 mb-4">
              <Users className="h-8 w-8 text-barranquilla-blue" />
            </div>
            <h3 className="font-bold mb-2">Audiencia</h3>
          ...
          <div className="bg-barranquilla-blue/5 rounded-lg p-6 text-center">
            <div className="mx-auto w-16 h-16 flex items-center justify-center rounded-full bg-barranquilla-blue/10 mb-4">
              <FileText className="h-8 w-8 text-barranquilla-blue" />
            </div>
            <h3 className="font-bold mb-2">Estructura</h3>
